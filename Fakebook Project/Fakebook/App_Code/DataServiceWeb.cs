...
public class DataServiceWeb
{
    ...
    static public string ConnectionString
    {
        get
        {
            return @"Data Source=.\SQLEXPRESS;AttachDbFilename=" + DataServiceWeb.path + @";Integrated Security=True;User Instance=True";
        }
    ...
    {
        object obj = null;
        SqlConnection connection = new SqlConnection(DataServiceWeb.ConnectionString);
